...
(cl:in-package project3_phase1-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GetNextDestination-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetNextDestination-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project3_phase1-srv:<GetNextDestination-request> is deprecated: use project3_phase1-srv:GetNextDestination-request instead.")))

(cl:ensure-generic-function 'current_x-val :lambda-list '(m))
(cl:defmethod current_x-val ((m <GetNextDestination-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project3_phase1-srv:current_x-val is deprecated.  Use project3_phase1-srv:current_x instead.")
  (current_x m))

(cl:ensure-generic-function 'current_y-val :lambda-list '(m))
(cl:defmethod current_y-val ((m <GetNextDestination-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project3_phase1-srv:current_y-val is deprecated.  Use project3_phase1-srv:current_y instead.")
  (current_y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetNextDestination-request>)))
  ...
  "project3_phase1/GetNextDestinationRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetNextDestination-request)))
  "Returns string type for a service object of type 'GetNextDestination-request"
  "project3_phase1/GetNextDestinationRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetNextDestination-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetNextDestination-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project3_phase1-srv:<GetNextDestination-response> is deprecated: use project3_phase1-srv:GetNextDestination-response instead.")))

(cl:ensure-generic-function 'next_x-val :lambda-list '(m))
(cl:defmethod next_x-val ((m <GetNextDestination-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project3_phase1-srv:next_x-val is deprecated.  Use project3_phase1-srv:next_x instead.")
  (next_x m))

(cl:ensure-generic-function 'next_y-val :lambda-list '(m))
(cl:defmethod next_y-val ((m <GetNextDestination-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project3_phase1-srv:next_y-val is deprecated.  Use project3_phase1-srv:next_y instead.")
  (next_y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetNextDestination-response>)))
  ...
  "project3_phase1/GetNextDestinationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetNextDestination-response)))
  "Returns string type for a service object of type 'GetNextDestination-response"
  "project3_phase1/GetNextDestinationResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetNextDestination)))
  ...
  "project3_phase1/GetNextDestination")